...
- (BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions
{
    ...
    [[BITHockeyManager sharedHockeyManager] configureWithIdentifier:@"cea7e3b3441911d"];
    [[BITHockeyManager sharedHockeyManager] setServerURL:@"https://b2bappshop.audi.de"];
